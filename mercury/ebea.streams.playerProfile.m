...
:- pred write(io.binary_output_stream, G, int, list(list(int)), io.state, io.state)
	<= asymmetricGame(G, C).
...
:- pred parsePlayerProfiles(int, list(list(int)), parseable.state, parseable.state).
...
:- pred parsePlayerProfileD(int, list(int), parseable.state, parseable.state).
...
:- pred parsePlayerProfileS(int, list(int), parseable.state, parseable.state).
:- mode parsePlayerProfileS(in, out, in, out) is semidet.
